...
comprehensive processing and analysis of DNA methylation data. Our package aims
to provide an efficient and integrated solution for several key functionalities:
The purpose of this vigentte is to show usage of the **main()** function.
...
-   Presents visual and quantitative mediums to
**explore and analyze variousepigenetic age measures**.
-   Offers matrix plots, line plots, and grouped bar charts for
**easy interpretation and comparison** of age estimates against
chronological age and covariates.

### Cell Count Estimation

-   Utilizes methylation data from provided IDAT files to
**estimate cell counts** for specific cell types including B Cells, CD4T Cells,
...
Load the package and identify the directory where methylation and covariate
data is stored.
...
Run the main function, notice that the attribute *useSampleSheet* is set to
TRUE. Ignore the encompassing if statement.
...
The data used for examples in this package is public and is available at:
<https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=GSE197646>
